  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="mb-6 grid grid-cols-3 gap-4 rounded-xl border border-border bg-white p-4 shadow-sm"
      >
          ...
          {visible.map((rec) => {
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-xl border border-border bg-white shadow-sm transition-all duration-200 hover:shadow-md ${
                  rec.urgency === 'high' ? 'ring-1 ring-destructive/20' : ''
                }`}
              >
                {/* Urgency header bar */}
                <div className="flex items-center justify-between rounded-t-xl bg-muted px-5 py-2">
                  ...
                  <button
                    ...
                    className="cursor-pointer rounded p-1 text-foreground/30 transition-colors duration-150 hover:bg-border hover:text-foreground/60"
                      ...
                      <div className="mt-4 flex flex-wrap gap-3">
                        {rec.subscription_id && (
                          <button
                            ...
                            className="cursor-pointer rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-foreground/70 transition-colors duration-150 hover:bg-muted"
                          >
                            View subscription
                          </button>
                        )}
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-foreground/70 transition-colors duration-150 hover:bg-muted"
                        >
